...
export default function HomePage() {
  return (
    <>
      {/* HERO */}
      <section className="b-hero container">
        <div className="b-hero__grid">
          <div>
            ...
            <h1 className="b-hero__title mt-2">
      ...
      <section className="section">
        <div className="container">
          <div className="text-center mb-5">
            ...
            <h2>One platform. <span style={{ background: "var(--yellow)", padding: "0 6px", border: "3px solid var(--border)", display: "inline-block", transform: "rotate(-1deg)" }}>Every skill.</span></h2>
          ...
          <div className="grid grid-auto">
            <article className="b-feature">
              <div className="b-feature__icon b-feature__icon--blue">💻</div>
            ...
            <article className="b-feature">
              <div className="b-feature__icon b-feature__icon--pink">🎙️</div>
            ...
            <article className="b-feature">
              <div className="b-feature__icon b-feature__icon--lime">🤖</div>
            ...
            <article className="b-feature">
              <div className="b-feature__icon">🎨</div>
        ...
        <div className="container">
          ...
          <div className="grid grid-3">
            <div className="b-card text-center">
              <div className="b-avatar b-avatar--lg" style={{ background: "var(--yellow)", color: "var(--black)", margin: "0 auto" }}>1</div>
              <h3 className="mt-2">Sign up free</h3>
              <p className="muted mt-1">Create your account in under 30 seconds. Email, Google or GitHub.</p>
            </div>
            <div className="b-card text-center">
              <div className="b-avatar b-avatar--lg" style={{ background: "var(--pink)", margin: "0 auto" }}>2</div>
            ...
            <div className="b-card text-center">
              <div className="b-avatar b-avatar--lg" style={{ background: "var(--lime)", color: "var(--black)", margin: "0 auto" }}>3</div>
      ...
      <section className="section">
        <div className="container">
          <div className="flex justify-between items-center mb-4" style={{ flexWrap: "wrap", gap: 16 }}>
            ...
            <Link href="/courses" className="b-btn b-btn--ghost">All courses →</Link>
          </div>
          <div className="grid grid-3">
            <Link href="/courses/python" className="b-course">
              <div className="b-course__cover b-course__cover--code">&lt;/&gt;<span className="b-tag b-course__badge">Bestseller</span></div>
            ...
            <Link href="/courses/web" className="b-course">
            ...
            <Link href="/courses/ai" className="b-course">
              <div className="b-course__cover b-course__cover--ai">🤖</div>
              <div className="b-course__body">
      ...
      {/* STATS */}
      <section className="section" style={{ background: "var(--black)", color: "var(--white)", borderTop: "3px solid var(--border)", borderBottom: "3px solid var(--border)" }}>
        <div className="container">
        ...
        <div className="container">
          ...
          <div className="grid grid-3">
            <div className="b-card b-card--sm">
              ...
              <p>"The Neo-Brutalist UI makes studying actually fun. I cleared my ICSE boards with 96% thanks to Vastavik."</p>
              <div className="flex items-center gap-1 mt-2"><div className="b-avatar">R</div><div><strong>Riya Sharma</strong><div className="muted" style={{ fontSize: "0.8rem" }}>Class 10 · ICSE</div></div></div>
            </div>
            <div className="b-card b-card--sm">
              <div className="b-tag b-tag--lime mb-2">⭐⭐⭐⭐⭐</div>
              <p>"The AI tutor is a game changer. It explains sorting algorithms better than my textbook."</p>
              <div className="flex items-center gap-1 mt-2"><div className="b-avatar" style={{ background: "var(--pink)" }}>A</div><div><strong>Arjun Patel</strong><div className="muted" style={{ fontSize: "0.8rem" }}>B.Tech CSE · Year 2</div></div></div>
            </div>
            <div className="b-card b-card--sm">
              <div className="b-tag b-tag--lime mb-2">⭐⭐⭐⭐⭐</div>
              <p>"Live classrooms with whiteboard are unreal. Feels like being in a real classroom, but better."</p>
              <div className="flex items-center gap-1 mt-2"><div className="b-avatar" style={{ background: "var(--lime)", color: "var(--black)" }}>S</div><div><strong>Sneha Verma</strong><div className="muted" style={{ fontSize: "0.8rem" }}>Class 12 · CBSE</div></div></div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* CTA */}
      <section className="section" style={{ background: "var(--yellow)", borderTop: "3px solid var(--border)", borderBottom: "3px solid var(--border)" }}>
