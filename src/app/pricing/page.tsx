...
export default function PricingPage() {
  ...
  const subscribe = (plan: string) => {
    ...
    // Razorpay UPI Autopay integration scaffold
    const options = {
      key: "rzp_test_YOUR_KEY_ID", // Replace with real key from env
    ...
    // In production: new (window as any).Razorpay(options).open();
